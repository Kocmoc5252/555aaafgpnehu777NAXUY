...
class OpenAIResponder:
    ...
    def _instructions(self) -> str:
        ...
        return (
            ...
            "Если в сообщении есть блок 'Точные данные из прямого источника', считай эти данные актуальными и используй их в ответе. "
            "Если в сообщении есть блок 'Актуальные данные из веб-поиска', используй эти данные как свежий контекст. "
            "Если прямые или поисковые данные уже содержат цифру курса/погоды/цены, не говори, что не видишь актуальную информацию. "
